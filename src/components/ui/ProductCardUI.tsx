...
export const ProductCardUI = ({ product }: ProductCardUIProps) => {
  return (
    <HeadlessProductCard product={product}>
      {(logic) => (
        <Card className="group bg-card hover:shadow-xl transition-all duration-300 overflow-hidden border-border">
              ...
              <div className="aspect-square bg-muted overflow-hidden relative">
                ...
                <div className="absolute top-3 left-3 flex flex-col gap-2">
                  ...
                  {logic.product.featured && (
                    <span className="bg-accent craft-accent text-accent-foreground text-xs px-3 py-1 rounded-full font-semibold shadow-lg">
                      Featured
                    </span>
                  )}
                  {!logic.inStock && (
